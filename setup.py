...
#
#     from sunny import metadata
#
# However, when we do this, we also import `sunny/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'sunny_cli = sunny.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'sunny_gui = sunny.gui:entry_point'
        # ]
    }
)
